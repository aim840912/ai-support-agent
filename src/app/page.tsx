    ...
    <div className="min-h-screen bg-zinc-50">
      ...
      <header className="sticky top-0 z-50 border-b border-zinc-200 bg-white/80 backdrop-blur-sm">
        <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-4 sm:px-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-semibold text-zinc-900">AI Support Agent</span>
          </div>
          ...
          <div className="flex items-center gap-2">
            <Link
              href="/login"
              className="rounded-lg px-3 py-1.5 text-sm font-medium text-zinc-700 hover:bg-zinc-100 transition-colors"
            >
              Sign In
            </Link>
            <Link
      ...
      <section className="bg-zinc-50 px-4 py-20 sm:px-6 sm:py-28">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-8 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
            <Link
              href="/register"
              className="flex w-full items-center justify-center gap-2 rounded-lg bg-zinc-900 px-6 py-2.5 text-sm font-medium text-white hover:bg-zinc-700 transition-colors sm:w-auto"
            >
              Get Started
            ...
            <Link
              href="/login"
              className="flex w-full items-center justify-center gap-2 rounded-lg border border-zinc-300 px-6 py-2.5 text-sm font-medium text-zinc-700 hover:bg-zinc-100 transition-colors sm:w-auto"
            >
              Sign In
            </Link>
          </div>
      ...
      <section className="bg-white px-4 py-16 sm:px-6 sm:py-20">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="mt-3 text-center text-sm text-zinc-500 sm:text-base">
          ...
          <div className="mt-10 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {features.map(({ icon: Icon, title, description }) => (
              ...
              >
                <div className="mb-4 inline-flex rounded-lg bg-zinc-100 p-2.5">
      ...
      <section className="bg-zinc-50 px-4 py-16 sm:px-6 sm:py-20">
        <div className="mx-auto max-w-xl text-center">
          ...
          <div className="mt-8">
            <Link
              href="/register"
              className="inline-flex items-center gap-2 rounded-lg bg-zinc-900 px-6 py-2.5 text-sm font-medium text-white hover:bg-zinc-700 transition-colors"
            >
              Get Started Free
              <ArrowRight className="h-4 w-4" aria-hidden="true" />
            </Link>
      ...
      <footer className="border-t border-zinc-200 bg-white px-4 py-6 sm:px-6">
        <div className="mx-auto flex max-w-6xl flex-col items-center gap-2 text-xs text-zinc-400 sm:flex-row sm:justify-between">
