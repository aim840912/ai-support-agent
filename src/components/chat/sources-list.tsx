    ...
    <div className="mt-2 space-y-1">
      ...
      <div className="flex flex-wrap gap-1.5">
        {sources.map((s, i) => (
          ...
          >
            <FileText className="w-3 h-3 shrink-0 text-muted-foreground" aria-hidden="true" />
            ...
            <ExternalLink className="w-3 h-3 shrink-0 text-muted-foreground" aria-hidden="true" />
          </div>
        ))}
      </div>
    </div>
